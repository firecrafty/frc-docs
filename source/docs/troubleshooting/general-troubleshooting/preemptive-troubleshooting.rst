...
.. image:: images/preemptive-troubleshooting/battery-connection.png

.. warning:: The tape that should be covering the battery connection in these examples has been removed to illustrate what is going on. On your robots, the connections **must** be covered.
...
.. image:: images/preemptive-troubleshooting/secure-robot-connection.png
...
.. image:: images/preemptive-troubleshooting/circuit-breaker.png
...
.. image:: images/preemptive-troubleshooting/pdp-connections.png
...
.. image:: images/preemptive-troubleshooting/pdp-fuses.png
...
.. image:: images/preemptive-troubleshooting/tools-flashlight.png
...
A Wago tool is nice to for redoing weidmuller connections with stranded wires.  Often I’ll do one to show the team, and then have them do the rest using the WAGO tool to press down the white-plunger while they insert the stranded wire.  The angle of the WAGO tool makes this particularly helpful.
